...
print('Подсказка: Чтобы ходить пользуйтесь W A S D.Так же в игре доступны ограбления,но они доступны от 15 уровня.Обворовывайте людей чтобы поднять уровень и заработать деньги - пользуйтесь клавишой j.Чтобы ознакомиться со всеми функциями игры пользуйтесь клавишой i')
# ходьба и управление
while True:
